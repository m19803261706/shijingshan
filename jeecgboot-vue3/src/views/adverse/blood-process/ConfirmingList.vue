...
<script lang="ts" name="blood-process-confirming" setup>
/**
 * 输血使用不良事件待确认列表页面
 * @description 输血科待确认整改的输血使用不良事件报告列表
 * @author TC Agent
 * @since 2025-12-19
...
import { confirmingColumns, pendingSearchFormSchema } from './bloodProcess.data';
import { getBloodConfirmingList } from '/@/api/adverse/bloodProcess';
...
const { tableContext } = useListPage({
  designScope: 'blood-process-confirming',
  tableProps: {
    title: '待确认报告列表',
    api: getBloodConfirmingList,
