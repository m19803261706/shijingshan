...
<script lang="ts" name="blood-process-closed" setup>
/**
 * 输血使用不良事件已结案列表页面
 * @description 输血科已结案的输血使用不良事件报告列表
 * @author TC Agent
 * @since 2025-12-19
...
import { closedColumns, closedSearchFormSchema } from './bloodProcess.data';
import { getBloodClosedList } from '/@/api/adverse/bloodProcess';
...
const { tableContext } = useListPage({
  designScope: 'blood-process-closed',
  tableProps: {
    title: '已结案报告列表',
    api: getBloodClosedList,
