...
<script lang="ts" name="clinic-audit-blood-completed" setup>
/**
 * 输血使用不良事件已审核列表页面
 * @description 临床科室已审核输血使用不良事件报告列表，显示审核结果和流转历史
 * @author TC Agent
 * @since 2025-12-19
...
import { completedColumns, completedSearchFormSchema } from './bloodAudit.data';
import { getBloodCompletedAuditList } from '/@/api/adverse/bloodAudit';
...
const { tableContext } = useListPage({
  designScope: 'clinic-audit-blood-completed',
  tableProps: {
    title: '已审核报告列表',
    api: getBloodCompletedAuditList,
