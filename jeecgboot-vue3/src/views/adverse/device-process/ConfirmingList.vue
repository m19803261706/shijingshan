...
<script lang="ts" name="device-process-confirming" setup>
/**
 * 医疗器械不良事件待确认列表页面
 * @description 器械科待确认整改的医疗器械不良事件报告列表
 * @author TC Agent
 * @since 2025-12-19
 * @see Issue #70
 */
...
import { confirmingColumns, pendingSearchFormSchema } from './deviceProcess.data';
import { getDeviceConfirmingList } from '/@/api/adverse/deviceProcess';
...
const { tableContext } = useListPage({
  designScope: 'device-process-confirming',
  tableProps: {
    title: '待确认报告列表',
    api: getDeviceConfirmingList,
