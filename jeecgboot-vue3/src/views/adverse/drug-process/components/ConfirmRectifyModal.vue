...
import { getDrugRectifyHistory, drugProcessConfirmRectify, drugProcessRejectRectify } from '/@/api/adverse/drugProcess';
...
const [registerModal, { closeModal, setModalProps }] = useModalInner(async (data) => {
  ...
  if (data?.record) {
    ...
    // 加载最新整改记录
    const rectifyList = await getDrugRectifyHistory(data.record.id);
