    ...
    <a-card title="整改要求" size="small" class="mb-4" v-if="rectifyData">
      <a-descriptions bordered :column="2" size="small">
        ...
        <a-descriptions-item label="整改要求" :span="2">
          <div style="white-space: pre-wrap;">{{ rectifyData.requirement || '请根据输血使用不良事件情况进行整改' }}</div>
        </a-descriptions-item>
        <!-- 显示上一轮退回原因 -->
...
import { submitBloodRectify } from '/@/api/adverse/bloodRectify';
import {
  eventNameOptions,
