-- ========================================
-- 药品不良反应上报系统 - 常用并用药品配置表
-- 版本: V1013
-- 描述: 创建常用并用药品配置表 drug_common_concomitant
-- 作者: TC Agent
-- 创建时间: 2025-12-19
-- 用途: 存储常用的并用药品信息，支持快速选择和使用统计
-- Issue: #34
-- Epic: #32
-- ========================================
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='常用并用药品配置表';

-- 添加表注释
ALTER TABLE `drug_common_concomitant` COMMENT = '常用并用药品配置表 - 存储常用的并用药品信息，支持快速选择和使用统计';
