 ...
 * @since 2025-12-19
 */
public interface IDrugCommonConcomitantService extends IService<DrugCommonConcomitant> {
     ...
     * @return 匹配的药品列表
     */
    List<DrugCommonConcomitant> searchByKeyword(String keyword);
     ...
     */
    boolean saveIfNotExists(DrugCommonConcomitant drug);
