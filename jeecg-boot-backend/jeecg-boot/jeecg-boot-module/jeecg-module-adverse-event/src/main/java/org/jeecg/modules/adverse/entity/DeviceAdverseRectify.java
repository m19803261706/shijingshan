 ...
 * 医疗器械不良事件整改表
 * <p>
 * 记录医疗器械不良事件报告的整改要求、整改措施和确认结果
 * </p>
 *
 * @author TC Agent
 * @since 2025-12-19
 * @see DeviceAdverseReport
 * @see <a href="https://github.com/m19803261706/shijingshan/issues/63">Issue #63</a>
 */
@Data
@TableName("device_adverse_rectify")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@Schema(description = "医疗器械不良事件整改表")
public class DeviceAdverseRectify implements Serializable {
     ...
     */
    @Dict(dicCode = "device_adr_confirm_result")
     ...
     */
    @Dict(dicCode = "device_adr_rectify_status")
