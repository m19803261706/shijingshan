 ...
 */
public interface IDrugAdverseRectifyService extends IService<DrugAdverseRectify> {
     ...
     */
    List<DrugAdverseRectify> selectByReportId(String reportId);
     ...
     */
    DrugAdverseRectify getLatestByReportId(String reportId);
     ...
     * @return 创建的整改记录
     */
    DrugAdverseRectify createRectify(String reportId, String requirement, Date deadline,
