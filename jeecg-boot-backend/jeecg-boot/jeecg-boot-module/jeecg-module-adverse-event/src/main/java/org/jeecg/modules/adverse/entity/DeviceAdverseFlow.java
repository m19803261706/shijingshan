 ...
 */
@Data
@TableName("device_adverse_flow")
@Accessors(chain = true)
@EqualsAndHashCode(callSuper = false)
@Schema(description = "医疗器械不良事件流转记录表")
public class DeviceAdverseFlow implements Serializable {
     ...
     * submit_rectify-提交整改, confirm_rectify-确认整改, reject_rectify-整改不通过, close-结案
     * </p>
     */
    @Dict(dicCode = "device_adr_flow_action")
